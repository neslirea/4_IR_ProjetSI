...
HD_PWD='/home/aubery/Documents/Projet_SI/4_IR_ProjetSI/VHDL/project_vhdl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AUL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AUL.tcl
