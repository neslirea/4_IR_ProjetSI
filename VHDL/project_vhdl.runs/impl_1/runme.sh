...
HD_PWD='/home/aubery/Documents/Projet_SI/4_IR_ProjetSI/VHDL/project_vhdl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AUL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AUL.tcl -notrace
